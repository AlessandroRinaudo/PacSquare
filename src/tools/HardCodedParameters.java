...
public class HardCodedParameters {
  ...
  public static final int defaultWidth = 1000, defaultHeight = 1000,
                          heroesStartX = 80, heroesStartY = 200, heroesWidth=80, heroesHeight=80, heroesStep = 3,
                          phantomWidth = 30, phantomHeight = 30, phantomStep = 2, fruitWidth = 30, fruitHeight = 30, fruitStep = 10;
  public static final int enginePaceMillis = 16, //vitesse a laquelle l'image se maj (plus petit tout se deplace plus vite)
